...
VL_ATTR_COLD void Vsim_soc___024root___dump_triggers__act(Vsim_soc___024root* vlSelf) {
    ...
    if ((0x40ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 6 is active: @(posedge sim_soc.u_cpu.u_pipe_exmem.clk)\n");
    }
    if ((0x80ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 7 is active: @(posedge sim_soc.u_cpu.u_pipe_memwb.clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vsim_soc___024root___dump_triggers__nba(Vsim_soc___024root* vlSelf) {
    ...
    if ((0x40ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 6 is active: @(posedge sim_soc.u_cpu.u_pipe_exmem.clk)\n");
    }
    if ((0x80ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 7 is active: @(posedge sim_soc.u_cpu.u_pipe_memwb.clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vsim_soc___024root___ctor_var_reset(Vsim_soc___024root* vlSelf) {
    ...
    vlSelf->sim_soc__DOT__u_cpu__DOT__stall = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7389073035840126288ull);
    ...
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__exmem_alu_result = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 3290423956367096562ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__exmem_wb_sel = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 4253972856803546428ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__exmem_pc_plus4 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 5462728560399972148ull);
    ...
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__exmem_fwd = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 15112256123763028478ull);
    ...
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__sa = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 4966595053380291203ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__sb = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10180015301048935190ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__mul_uu = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 12418884599600059776ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__mul_ss = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 17314875488337162325ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_ex__DOT__mul_su = VL_SCOPED_RAND_RESET_Q(64, __VscopeHash, 14256039905422687313ull);
    ...
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_wb__DOT__memwb_alu_result = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 12186395968795138075ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_wb__DOT__memwb_mem_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 9555129628595409919ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_wb__DOT__memwb_pc_plus4 = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 13621860922928876096ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_wb__DOT__memwb_wb_sel = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 15701880731325216284ull);
    vlSelf->sim_soc__DOT__u_cpu__DOT__u_wb__DOT__wb_write_data = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 1966196552141311356ull);
