...
module tb_coe;
    ...
    // In a 5-stage pipeline, a JAL-to-self at 0x80000010 causes pc_out to
    // cycle through three consecutive addresses with period 3 (the JAL plus
    // the two instructions speculatively fetched before the branch flushes).
    // Detect this by checking whether pc_out repeats every 3 cycles.
    ...
    always @(posedge clk) begin
        if (!rst_n) begin
            ...
            // Self-loop detection: PC repeats every 3 cycles (pipeline period).
            // This correctly handles a JAL-to-self inside a 5-stage pipeline.
